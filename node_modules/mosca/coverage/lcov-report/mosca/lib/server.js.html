...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/server.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/server.js</span></h1>
    <h2>
        
        Statements: <span class="metric">89.19% <small>(132 / 148)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">76.12% <small>(51 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.97% <small>(32 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">89.19% <small>(132 / 148)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/</a> &#187; server.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        that.opts.http.port = that.opts.http.port || <span class="branch-1 cbranch-no" title="branch not covered" >3000;</span>
...
&nbsp;
        that.attachHttpServer(server);
        that.servers.push(server);
        that.opts.https.port = that.opts.https.port || <span class="branch-1 cbranch-no" title="branch not covered" >3001;</span>
