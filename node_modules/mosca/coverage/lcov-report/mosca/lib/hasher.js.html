...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/hasher.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/hasher.js</span></h1>
    <h2>
        
        Statements: <span class="metric">80% <small>(28 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/</a> &#187; hasher.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  var opts = args.pop() || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
  var queue = [];
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof opts.password !== 'string') {
<span class="cstat-no" title="statement not covered" >    queue.push(genPass);</span>
  }
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function genPass(opts, cb) {</span>
<span class="cstat-no" title="statement not covered" >  debug("missing password, generating");</span>
  // generate a 10-bytes password
<span class="cstat-no" title="statement not covered" >  crypto.randomBytes(10, <span class="fstat-no" title="function not covered" >function(err, buffer) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (buffer) {</span>
<span class="cstat-no" title="statement not covered" >      opts.password = buffer.toString("base64");</span>
    }
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof hash === 'string') {
