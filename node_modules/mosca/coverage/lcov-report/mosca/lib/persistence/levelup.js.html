...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/persistence/levelup.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/persistence/levelup.js</span></h1>
    <h2>
        
        Statements: <span class="metric">100% <small>(117 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">100% <small>(117 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/persistence/</a> &#187; levelup.js</div>
</div>
<div class="body">
...
&nbsp;
  stream.on("data", function(data) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (qlobber.match(data.key).length &gt; 0) {
