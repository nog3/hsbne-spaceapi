...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/persistence/redis.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/persistence/redis.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.53% <small>(121 / 128)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/persistence/</a> &#187; redis.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (!result || typeof subs !== 'object') {
<span class="cstat-no" title="statement not covered" >        if (!retried) {</span>
<span class="cstat-no" title="statement not covered" >          setTimeout(newSub.bind(null, key, cb, true), 500);</span>
        }
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (options.password) {
<span class="cstat-no" title="statement not covered" >    client.auth(options.password);</span>
  }
&nbsp;
  return client;
&nbsp;
