...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/persistence/mongo.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/persistence/mongo.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.83% <small>(110 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/persistence/</a> &#187; mongo.js</div>
</div>
<div class="body">
...
&nbsp;
  // Connect to the db
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (options.connection) {
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (done) {
    return done();
  }
};
&nbsp;
...
&nbsp;
      var now = Date.now();
      done(err, (subscriptions || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.reduce(function(obj, sub) {
...
&nbsp;
  stream.on("data", function(data) {
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (qlobber.match(data.topic).length &gt; 0) {
...
&nbsp;
      ...
      completed++;
&nbsp;
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (done &amp;&amp; ended &amp;&amp; started === completed) {
        done();
      }
    });
  });
...
MongoPersistence.prototype.close = function(cb) {
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (this.db &amp;&amp; this.options.autoClose !== false) {
