...
<html lang="en">
<head>
    <title>Code coverage report for mosca/lib/cli.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">mosca/lib/cli.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92.98% <small>(106 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">92.98% <small>(106 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">mosca/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var pkg = require("../package");
...
&nbsp;
    if (program.cert || program.key) {
      <span class="missing-if-branch" title="else path not taken"" >E</span>if (program.cert &amp;&amp; program.key) {
        opts.secure = {};
...
&nbsp;
  argv = argv || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
